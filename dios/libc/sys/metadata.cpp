...
extern "C" __invisible const _MD_Function *__md_get_pc_meta_divm( _VM_CodePointer pc )
{
...
extern "C" const _MD_Function *__md_get_pc_meta( _VM_CodePointer )
    __attribute__((weak, alias("__md_get_pc_meta_divm")));
