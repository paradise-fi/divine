...
class __int128_
    : public __node
{
    static const size_t n = sizeof("__int128_") - 1;
public:

    virtual size_t first_size() const {return n;}
    virtual char* first_demangled_name(char* buf) const
    {
        strncpy(buf, "__int128_", n);
        return buf + n;
    }
};
...
class __unsigned_int128
    : public __node
{
    static const size_t n = sizeof("unsigned __int128_") - 1;
public:

    virtual size_t first_size() const {return n;}
    virtual char* first_demangled_name(char* buf) const
    {
        strncpy(buf, "unsigned __int128_", n);
        return buf + n;
    }
};
...
public:
    ...
    virtual char* first_demangled_name(char* buf) const
    {
        strncpy(buf, "(unsigned __int128_)", 19);
        buf += 19;
        strncpy(buf, __name_, __size_);
        return buf + __size_;
    }
