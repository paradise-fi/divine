...
#define SYSCALL0(name, ret) ret name( ) { \
	ret retval;\
	 __dios_syscall( __dios::_SC_ ## name  &retval,);\
    return retval; }
#define SYSCALL1(name, ret, arg1, name1) ret name( arg1 name1) { \
	ret retval;\
	 __dios_syscall( __dios::_SC_ ## name, &retval, name1);\
    return retval; }
#define SYSCALL2(name, ret, arg1, name1, arg2, name2) ret name( arg1 name1, arg2 name2) { \
	ret retval;\
...
#define SYSCALL4(name, ret, arg1, name1, arg2, name2,  arg3, name3,  arg4, name4) \
 ret name( arg1 name1, arg2 name2, arg3 name3,  arg4 name4) { \
    ...
    return retval; }
#define SYSCALL5(name, ret, arg1, name1, arg2, name2,  arg3, name3,  arg4, name4, arg5, name5) \
