...
#define _PDCLIB_FLT_RADIX       _PDCLIB_concat( _PDCLIB_FP_SINGLE_RADIX, f )
#define _PDCLIB_FLT_MANT_DIG    _PDCLIB_FP_SINGLE_MANT_DIG
#define _PDCLIB_FLT_DIG         _PDCLIB_FP_SINGLE_DIG
#define _PDCLIB_FLT_EPSILON     _PDCLIB_concat( _PDCLIB_FP_SINGLE_EPSILON, f )
#define _PDCLIB_FLT_MIN_EXP     _PDCLIB_FP_SINGLE_MIN_EXP
#define _PDCLIB_FLT_MIN         _PDCLIB_concat( _PDCLIB_FP_SINGLE_MIN, f )
#define _PDCLIB_FLT_MIN_10_EXP  _PDCLIB_FP_SINGLE_MIN_10_EXP
#define _PDCLIB_FLT_MAX_EXP     _PDCLIB_FP_SINGLE_MAX_EXP
#define _PDCLIB_FLT_MAX         _PDCLIB_concat( _PDCLIB_FP_SINGLE_MAX, f )
#define _PDCLIB_FLT_MAX_10_EXP  _PDCLIB_FP_SINGLE_MAX_10_EXP

#define _PDCLIB_DBL_RADIX       _PDCLIB_FP_DOUBLE_RADIX
#define _PDCLIB_DBL_MANT_DIG    _PDCLIB_FP_DOUBLE_MANT_DIG
#define _PDCLIB_DBL_DIG         _PDCLIB_FP_DOUBLE_DIG
#define _PDCLIB_DBL_EPSILON     _PDCLIB_FP_DOUBLE_EPSILON
#define _PDCLIB_DBL_MIN_EXP     _PDCLIB_FP_DOUBLE_MIN_EXP
#define _PDCLIB_DBL_MIN         _PDCLIB_FP_DOUBLE_MIN
#define _PDCLIB_DBL_MIN_10_EXP  _PDCLIB_FP_DOUBLE_MIN_10_EXP
#define _PDCLIB_DBL_MAX_EXP     _PDCLIB_FP_DOUBLE_MAX_EXP
#define _PDCLIB_DBL_MAX         _PDCLIB_FP_DOUBLE_MAX
#define _PDCLIB_DBL_MAX_10_EXP  _PDCLIB_FP_DOUBLE_MAX_10_EXP

#define _PDCLIB_LDBL_RADIX       _PDCLIB_concat( _PDCLIB_FP_EXTENDED_RADIX, l )
#define _PDCLIB_LDBL_MANT_DIG    _PDCLIB_FP_EXTENDED_MANT_DIG
#define _PDCLIB_LDBL_DIG         _PDCLIB_FP_EXTENDED_DIG
#define _PDCLIB_LDBL_EPSILON     _PDCLIB_concat( _PDCLIB_FP_EXTENDED_EPSILON, l )
#define _PDCLIB_LDBL_MIN_EXP     _PDCLIB_FP_EXTENDED_MIN_EXP
#define _PDCLIB_LDBL_MIN         _PDCLIB_concat( _PDCLIB_FP_EXTENDED_MIN, l )
#define _PDCLIB_LDBL_MIN_10_EXP  _PDCLIB_FP_EXTENDED_MIN_10_EXP
#define _PDCLIB_LDBL_MAX_EXP     _PDCLIB_FP_EXTENDED_MAX_EXP
#define _PDCLIB_LDBL_MAX         _PDCLIB_concat( _PDCLIB_FP_EXTENDED_MAX, l )
#define _PDCLIB_LDBL_MAX_10_EXP  _PDCLIB_FP_EXTENDED_MAX_10_EXP
