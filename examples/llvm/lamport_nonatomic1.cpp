 ...
 *         $ divine verify -p deadlock lamport_nonatomic1.bc -d
 *         $ divine verify -p progress lamport_nonatomic1.bc -f -d
 ...
 *         $ divine verify -p deadlock lamport_nonatomic1-bug.bc -d
 *
