...
void LtlPreferences::readSettings()
{
  Settings s("syntax");
...
void LtlPreferences::writeSettings()
{
  Settings s("syntax");
...
void LtlPreferences::onResetForeground()
{
...
void LtlPreferences::onResetBackground()
{
  Q_ASSERT(target_);
