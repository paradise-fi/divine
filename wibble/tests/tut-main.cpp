...
int main(int argc,const char* argv[])
{
  ...
  try
  {
    ...
    {
      wibble::tut::runner.get().run_tests(argv[1]);
    }
    else if( argc == 3 )
    {
      wibble::tut::runner.get().run_test(argv[1],::atoi(argv[2]));
    }
  }
