...
// V: rx0ry0 CC_OPT: -DCHECK=0 ERR: ERR_rx0ry0
// V: rx1ry0 CC_OPT: -DCHECK=1 ERR: ERR_rx1ry0
// V: rx1ry1 CC_OPT: -DCHECK=2 ERR: ERR_rx1ry1
...
int main() {
    ...
    switch ( CHECK ) {
        ...
        case 0: REACH( rx == 0 && ry == 0 ); /* ERR_rx0ry0 */
                break;
        case 1: REACH( rx == 1 && ry == 0 ); /* ERR_rx1ry0 */
                break;
        case 2: REACH( rx == 1 && ry == 1 ); /* ERR_rx1ry1 */
                break;
    }
}
