...
//                ::= u <source-name>    # vendorended type
...
//         ension     ::= <operator-name>                            # unresolved operator-function-id
//         ension     ::= <operator-name> <template-args>            # unresolved operator template-id
...
// <unresolved-name>
// ension        ::= srN <unresolved-type> [<template-args>] <unresolved-qualifier-level>* E <base-unresolved-name>
//                   ::= [gs] <base-unresolved-name>                     # x or (with "gs") ::x
//                   ::= [gs] sr <unresolved-qualifier-level>+ E <base-unresolved-name>  
//                                                                       # A::x, N::y, A<T>::z; "gs" means leading "::"
//                   ::= sr <unresolved-type> <base-unresolved-name>     # T::x / decltype(p)::x
// ension        ::= sr <unresolved-type> <template-args> <base-unresolved-name>
...
//        ::= U <source-name> <type>  # vendorended type qualifier
//ension := U <objc-name> <objc-type>  # objc-type<identifier>
//ension := <vector-type> # <vector-type> starts with Dv
...
//                   ::= rs    # >>            
//                   ::= rS    # >>=           
//                   ::= v <digit> <source-name>        # vendorended operator
...
//    ension, the abi says <template-arg>+
...
//                                     # No <type>
//     ension ::= TC <first type> <number> _ <second type> # construction vtable for second-in-first
//     ension ::= GR <object name> # reference temporary for object
