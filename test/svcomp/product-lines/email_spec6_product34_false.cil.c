/* TAGS: c sym big */
/* VERIFY_OPTS: --symbolic -o nofail:malloc -o ignore:contol */
...
static __inline void __utac_acc__EncryptDecrypt_spec__1(int msg ) 
...
static __inline void __utac_acc__EncryptDecrypt_spec__2(int client , int msg ) 
{ int tmp ;
  int tmp___0 ;
  int tmp___1 ;
