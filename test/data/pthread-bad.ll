...
@.str2 = private unnamed_addr constant [35 x i8] c"thread finished with %d, x = %d...\00", align 1
...
define noalias i8* @start(i8* nocapture %x) nounwind uwtable {
...
define i32 @main() nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !98
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !98
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !98
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !98
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !98
  %8 = load i32* %x, align 4, !dbg !98, !tbaa !83
  call void (i8*, ...)* @__divine_builtin_trace(i8* getelementptr inbounds ([35 x i8]* @.str2, i64 0, i64 0), i8* %7, i32 %8) nounwind, !dbg !98
  %9 = ptrtoint i8* %7 to i64, !dbg !99
  %10 = trunc i64 %9 to i32, !dbg !99
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !99
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !99
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !99
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !99
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !25), !dbg !99
  %11 = load i32* %x, align 4, !dbg !99, !tbaa !83
  %12 = icmp eq i32 %10, %11, !dbg !99
  %13 = zext i1 %12 to i32, !dbg !99
  call void @__divine_builtin_assert(i32 %13) nounwind, !dbg !99
  ret i32 0, !dbg !101
}
...
!27 = metadata !{i32 720942, i32 0, metadata !28, metadata !"pthread_join", metadata !"pthread_join", metadata !"", metadata !28, i32 103, metadata !18, i1 true, i1 true, i32 0, i32 0, i32 0, i32 256, i1 true, null, null, null, metadata !29} ; [ DW_TAG_subprogram ]
...
!31 = metadata !{i32 721153, metadata !27, metadata !"ptid", metadata !28, i32 16777319, metadata !24, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!32 = metadata !{i32 721153, metadata !27, metadata !"x", metadata !28, i32 33554535, metadata !33, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!33 = metadata !{i32 720911, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !9} ; [ DW_TAG_pointer_type ]
!34 = metadata !{i32 720942, i32 0, metadata !28, metadata !"pthread_create", metadata !"pthread_create", metadata !"", metadata !28, i32 83, metadata !18, i1 true, i1 true, i32 0, i32 0, i32 0, i32 256, i1 true, null, null, null, metadata !35} ; [ DW_TAG_subprogram ]
!35 = metadata !{metadata !36}
!36 = metadata !{metadata !37, metadata !39, metadata !43, metadata !47, metadata !48}
!37 = metadata !{i32 721153, metadata !34, metadata !"ptid", metadata !28, i32 16777296, metadata !38, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!38 = metadata !{i32 720911, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !24} ; [ DW_TAG_pointer_type ]
!39 = metadata !{i32 721153, metadata !34, metadata !"attr", metadata !28, i32 33554513, metadata !40, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
...
!43 = metadata !{i32 721153, metadata !34, metadata !"entry", metadata !28, i32 50331730, metadata !44, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
...
!47 = metadata !{i32 721153, metadata !34, metadata !"arg", metadata !28, i32 67108946, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!48 = metadata !{i32 721152, metadata !49, metadata !"init", metadata !28, i32 84, metadata !50, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!49 = metadata !{i32 720907, metadata !34, i32 83, i32 1, metadata !28, i32 3} ; [ DW_TAG_lexical_block ]
...
!65 = metadata !{i32 720948, i32 0, null, metadata !"PTHREAD_MUTEX_NORMAL", metadata !"PTHREAD_MUTEX_NORMAL", metadata !"", metadata !28, i32 99, metadata !66, i32 0, i32 1, i32* @PTHREAD_MUTEX_NORMAL} ; [ DW_TAG_variable ]
!66 = metadata !{i32 720934, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !16} ; [ DW_TAG_const_type ]
!67 = metadata !{i32 720948, i32 0, null, metadata !"PTHREAD_MUTEX_RECURSIVE", metadata !"PTHREAD_MUTEX_RECURSIVE", metadata !"", metadata !28, i32 100, metadata !66, i32 0, i32 1, i32* @PTHREAD_MUTEX_RECURSIVE} ; [ DW_TAG_variable ]
!68 = metadata !{i32 720948, i32 0, null, metadata !"PTHREAD_MUTEX_RECURSIVE_NP", metadata !"PTHREAD_MUTEX_RECURSIVE_NP", metadata !"", metadata !28, i32 101, metadata !66, i32 0, i32 1, i32* @PTHREAD_MUTEX_RECURSIVE_NP} ; [ DW_TAG_variable ]
...
!86 = metadata !{i32 7, i32 5, metadata !14, null}
...
!94 = metadata !{i32 104, i32 5, metadata !95, metadata !93}
!95 = metadata !{i32 720907, metadata !27, i32 103, i32 51, metadata !28, i32 2} ; [ DW_TAG_lexical_block ]
!96 = metadata !{i32 105, i32 5, metadata !95, metadata !93}
...
!100 = metadata !{i32 106, i32 5, metadata !95, metadata !93}
!101 = metadata !{i32 22, i32 5, metadata !23, null}
!102 = metadata !{i32* null}
!103 = metadata !{i32 81, i32 49, metadata !34, null}
!104 = metadata !{i8* (i8*)* @start}
!105 = metadata !{i32 82, i32 35, metadata !34, null}
!106 = metadata !{i32 84, i32 18, metadata !49, null}
!107 = metadata !{i32 84, i32 26, metadata !49, null}
!108 = metadata !{i32 85, i32 5, metadata !49, null}
!109 = metadata !{i32 87, i32 5, metadata !49, null}
!110 = metadata !{i32 88, i32 5, metadata !49, null}
...
!121 = metadata !{i32 73, i32 5, metadata !62, null}
!122 = metadata !{i32 74, i32 5, metadata !62, null}
!123 = metadata !{i32 75, i32 24, metadata !62, null}
!124 = metadata !{i32 76, i32 5, metadata !62, null}
!125 = metadata !{i32 77, i32 5, metadata !62, null}
